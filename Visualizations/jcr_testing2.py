# -*- coding: utf-8 -*-
"""
Created on Sat Jul 15 00:36:47 2017
...
#                                           face_color=(0.2, 0.2, 1))
        ...
        self.axis_x2 = visuals.AxisVisual(pos_xax + [[0,-50],[0,-50]], (0, 100), (0., 1.))
...
#        self.line.draw()
    ...
    def on_resize(self, event):
        ...
        self.axis_x2.transforms.configure(canvas=self, viewport=vp)
